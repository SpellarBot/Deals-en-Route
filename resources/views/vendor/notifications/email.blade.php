...
@section('content')
                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding:30px;" class="pa"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td align="center" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:19px; color:#777777; line-height:22px; font-weight:bold; padding:0 0 25px;" class="pb">Forgot your password to Deals en Route?</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:15px; color:#777777; line-height:20px; padding:0 0 20px;">Click the link below to choose a new one.</td>
                                </tr>
                                <tr>
                                  <td align="center" valign="top" style="padding:0 0 20px;"><table width="135" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#3b5997" style="background-color:#3b5997;">
                                      <tr>
                                        <td height="35" align="center" valign="middle" style="font-family:'Lato', Arial, sans-serif; font-size:14px; color:#ffffff;"><a href="{{$actionUrl}}" target="_blank" style="text-decoration:none; color:#ffffff; display:block; line-height:32px;">Reset Password</a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
