                    ...
                    <div class="col-left padding-bottom-mobile toshow" id="scene1">
                        ...
                        <div class="outer-button-container">
                            <div class="normal-button-container">
                                <a data-target="#follow" href="{{ route('vendorindex')}}"  return false;" class="btn btn-default normal-links hover-state popup-open">Inqury for Business<div class="icon-container"><i class="icon icon-arrow-right"></i></div></a>
                                <a data-target="#follow" href="{{ route('vendorindex')}}"  return false;" class="btn btn-default normal-links normal popup-open">Inqury for Business<div class="icon-container"><i class="icon icon-arrow-right"></i></div></a>
                            </div>
                            <div class="normal-button-container">
                                <a data-target="#follow" href="#" onClick="event.preventDefault(); return false;" class="btn btn-default normal-links hover-state popup-open"><div class="icon-container"><i class="icon fa fa-apple"></i></div>Download iOS App<div class="icon-container"><i class="icon icon-arrow-right"></i></div></a>
                                <a data-target="#follow" href="#" onClick="event.preventDefault(); return false;" class="btn btn-default normal-links normal popup-open"><div class="icon-container"><i class="icon fa fa-apple"></i></div>Download iOS App<div class="icon-container"><i class="icon icon-arrow-right"></i></div></a>
                            </div>
                        </div>
                    </div>
