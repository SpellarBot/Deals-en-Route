                                           ...
                                           <div class="errormessage"> </div>
                                             ...
                                             <div class="col-sm-6">
                                                   ...
                                                   {{ Form::select('vendor_category',[''=>'Select Category']+$signup_category_images,$category_image->category_id,
                                                    ...
                                                    {{ Form::text('vendor_city', '', ['placeholder'=>'City/State','class'=>'form-control']) }}
                                                   ...
                                                   <div class="form-group">
                                                   {{ Form::text('vendor_phone',null, ['placeholder'=>'Phone (x-xxx-xxx-xxxx)','data-mask'=>"9-999-999-9999",'maxlength'=>'11','class'=>'form-control']) }}      
                                                     </div>
