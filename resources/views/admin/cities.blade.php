...
<html lang="en">
    ...
    <body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid cities-content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-30">
                                <ul role="tablist" class="nav nav-tabs">
                                    ...
                                    <li role="presentation"><a href="#decline_request" aria-controls="profile" role="tab" data-toggle="tab">Decline Cities</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- START DATATABLE 1-->
                        ...
                        <div class="tab-content clearfix">
                            ...
                            <div id="decline_request" role="tabpanel" class="tab-pane">
                                <!-- START DATATABLE 1-->
                                <div class="row">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                                    ...
                                                    <table id="decline" class="table table-striped table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>State</th>                                                              
                                                                <th>Country</th>
                                                                <th>Requested Users</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach($decline_city as $row)
                                                            <tr>
                                                                <td>{{$row->name}}</td>
                                                                <td>{{$row->state}}</td>
                                                                <td>{{$row->county}}</td>
        ...
        <script type="text/javascript">
            function cancelCity(link){
            $('#accept_request').attr("href", link);
            }
            function getUsers(city, state, country, is_review){
            $.ajax({
            url: "{{ asset('/admin/get-request-user')}}",
                    data: {'city' : city, 'state' : state, 'country' : country, 'is_review' : is_review},
                    dataType: "json",
                    cache: false,
                    ...
                    data = data + '<tr><td>' + response[i].first_name + ' ' + response[i].last_name + '</td><td>' + response[i].date + '</td></tr>';
                    }
                    $('#user_list').html(data)
                    }
            });
        ...
        <div class="modal fade" id="myModal_request" role="dialog">
            <div class="modal-dialog">
        ...
        <div class="modal fade" id="myModal_users" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-danger pull-right" onclick="$('#myModal_users').modal('hide');" type="button" style="margin-left: 10px;">Close</button>
