                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding:30px;" class="pa"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="center" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:19px; color:#777777; line-height:22px; font-weight:bold; padding:0 0 25px;" class="pb">Password for manual login</td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:15px; color:#777777; line-height:20px; padding:0 0 20px;">Thanks for creating an account with Dealsenroute <br> 
                                    your dummy password for manual login is {{ $password }} .</td>
                                </tr>
                                <tr>
