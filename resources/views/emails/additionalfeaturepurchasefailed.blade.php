...
<tr>
    <td bgcolor="#ffffff" align="center" valign="top" style="padding:30px;" class="pa"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="left" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:15px; color:#777777; line-height:20px; padding:0 0 20px;">“Oh no! Your payment failed no charges were made. Don’t worry, we got your back. Please try again or contact customer service at <a href="mailto:support@dealsenroute.com">support@dealsenroute.com</a> if problems persist."</td>
            </tr>
            <tr>
