                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding:30px;" class="pa"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="center" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:19px; color:#777777; line-height:22px; font-weight:bold; padding:0 0 25px;" class="pb">Add Category - Request : {{$name}}</td>
                                </tr>
<!--                                <tr>
                                  <td align="left" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:15px; color:#777777; line-height:20px; padding:0 0 20px;">Thank you very much showing your intrest to onboard, we have received a request to add your business category, we are reviewing your request once approved we will let you know.</td>
                                </tr>-->
                                <tr>
                                  <td align="left" valign="top" style="font-family:'Lato', Arial, sans-serif; font-size:15px; color:#777777; line-height:20px; padding:0 0 20px;"> Your request for business category as been approved.Your requested category has been added into website.  Please click on signup now.</td>
                                </tr>
                                <tr>
